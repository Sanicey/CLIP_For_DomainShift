...
# ---------------------------------------------------------------------------- #
_C.Target = CN()
_C.Target.NAMES = ('market1501')
# Root directory where datasets should be used (and downloaded if not found)
_C.Target.ROOT_DIR = ('../data')

# ---------------------------------------------------------------------------- #
# Support_set
# ---------------------------------------------------------------------------- #
_C.Support_set = CN()
_C.Support_set.Stage1model = ('/home/sanicee/PycharmProjects/CLIP_For_DomainShift/output/vit_clip/ViT-B-16_stage1_120.pth')
_C.Support_set.NAMES = ('dukemtmc')
_C.Support_set.ROOT_DIR = ('./Support_set')
_C.Support_set.OUTPUT_DIR = ('./output/domain_shift')
